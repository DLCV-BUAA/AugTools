...
if __name__ == "__main__": 
    extension = GetLambadaModelExtension(cls_model_dir='augtools/extensions/model/lambada/cls', gen_model_dir='augtools/extensions/model/lambada/gen', threshold=0.3, device='cpu')
    rs = None
    rs = extension(rs)
