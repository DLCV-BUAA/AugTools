...
if __name__ == '__main__':
	...
	parser.add_argument('--train_data_path', default='./test/res/text/classification.csv', help='Data path of training file')
	parser.add_argument('--val_data_path', default='./test/res/text/classification.csv', help='Data path of validation file')
